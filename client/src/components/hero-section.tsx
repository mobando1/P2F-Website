        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <FadeIn delay={0.2}>
              <div className="flex flex-col sm:flex-row gap-4">
                <Button
                  onClick={() => { analytics.ctaClicked('booking', language); onBookingClick(); }}
                ...
                <Button
                  onClick={() => { analytics.ctaClicked('plans', language); onPlansClick(); }}
                  variant="outline"
          ...
          <FadeIn direction="right" delay={0.3}>
            <div className="relative">
              ...
              <div className="absolute -top-4 -left-4 bg-white text-passport-blue p-4 rounded-xl shadow-lg">
                <div className="text-2xl font-bold">1000+</div>
                <div className="text-sm">{t('hero.statsStudents')}</div>
              </div>

              <div className="absolute -bottom-4 -right-4 passport-orange text-white p-4 rounded-xl shadow-lg">
