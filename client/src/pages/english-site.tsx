...
export default function EnglishSite() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Inglés para Niños - Simplified */}
      <section id="ingles-para-ninos" className="py-16 bg-gradient-to-b from-blue-50 to-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <div className="bg-white rounded-2xl p-8 shadow-lg">
              ...
              <div className="flex flex-wrap justify-center gap-4 mb-6 text-sm text-gray-600">
                <span className="bg-blue-100 text-blue-800 px-3 py-1 rounded-full">Edades 5-17</span>
                <span className="bg-blue-100 text-blue-800 px-3 py-1 rounded-full">Juegos Interactivos</span>
                <span className="bg-blue-100 text-blue-800 px-3 py-1 rounded-full">Instructores Nativos</span>
                <span className="bg-blue-100 text-blue-800 px-3 py-1 rounded-full">Aprendizaje Cultural</span>
              </div>
              <Link href="/en/children">
