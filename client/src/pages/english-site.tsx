          ...
          <div className="max-w-6xl mx-auto space-y-20 md:space-y-24">
              ...
              <div className="bg-white rounded-3xl p-10 md:p-16 shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 cursor-pointer">
                <div className="text-center">
                  ...
                  <div className="w-20 h-20 md:w-24 md:h-24 bg-gradient-to-br from-blue-100 to-blue-50 border-2 border-blue-200 rounded-full flex items-center justify-center mx-auto mb-8 group-hover:-translate-y-1 transition-transform duration-300">
                    <Star className="w-10 h-10 md:w-12 md:h-12 text-blue-600" />
                  </div>
            ...
            <Link href="/en/business" className="block group focus:outline-none focus:ring-4 focus:ring-amber-300 rounded-3xl">
              <div className="bg-white rounded-3xl p-10 md:p-16 shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 cursor-pointer">
                <div className="text-center">
                  {/* Ícono principal */}
                  <div className="w-20 h-20 md:w-24 md:h-24 bg-gradient-to-br from-amber-100 to-amber-50 border-2 border-amber-200 rounded-full flex items-center justify-center mx-auto mb-8 group-hover:-translate-y-1 transition-transform duration-300">
                    <Briefcase className="w-10 h-10 md:w-12 md:h-12 text-amber-600" />
                  </div>
                  ...
                  <div className="flex flex-wrap justify-center gap-3 mb-8 md:gap-4">
                    <div className="hidden md:flex flex-wrap justify-center gap-4">
                      <span className="bg-white border-2 border-amber-200 text-amber-700 px-4 py-2 rounded-full text-sm font-medium hover:bg-amber-50 transition-colors flex items-center gap-2">
                    ...
                    {/* Mobile: Scroll horizontal */}
                    <div className="md:hidden flex gap-3 overflow-x-auto pb-2 snap-x snap-mandatory w-full">
                      <span className="bg-white border-2 border-amber-200 text-amber-700 px-4 py-2 rounded-full text-sm font-medium hover:bg-amber-50 transition-colors flex items-center gap-2 snap-start flex-shrink-0">
                        <Stethoscope className="w-4 h-4" />
                        Salud y Medicina
                      </span>
                      <span className="bg-white border-2 border-amber-200 text-amber-700 px-4 py-2 rounded-full text-sm font-medium hover:bg-amber-50 transition-colors flex items-center gap-2 snap-start flex-shrink-0">
                  ...
                  {/* Botón CTA */}
                  <div className="inline-block">
                    <div className="bg-amber-500 hover:bg-amber-600 text-white px-8 py-4 rounded-full font-semibold text-lg hover:shadow-lg hover:-translate-y-1 transition-all duration-300 flex items-center gap-3 group">
